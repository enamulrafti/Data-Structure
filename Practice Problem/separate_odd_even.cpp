...
node* even_list(node *head);

int main()
{
    node *head = NULL,*head1=NULL,*head2=NULL, *nn, *temp;
    int ch;
        ...
        else if(ch==10)
        {
            ...
            while(temp!=NULL)
            {
                if(temp->data %2==0)
                {
                    if(head1==NULL)
                    {
                        head1=insert_head(head1,temp);
                    }
                    else
                    {
                        head1=insert_tail(head1,temp);
                    }
                }
                else
                {
                    if(head2==NULL)
                    {
                        head2=insert_head(head2,temp);
                    }
                    else
                    {
                        head2=insert_tail(head2,temp);
                    }
